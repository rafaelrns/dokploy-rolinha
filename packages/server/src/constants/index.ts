...
const INSECURE_DEFAULT_AUTH_SECRET = "better-auth-secret-123456789";
const ALLOW_INSECURE_DEFAULT_AUTH_SECRET =
	process.env.ALLOW_INSECURE_DEFAULT_AUTH_SECRET === "true";

if (
	process.env.NODE_ENV === "production" &&
	!process.env.BETTER_AUTH_SECRET &&
	!ALLOW_INSECURE_DEFAULT_AUTH_SECRET
) {
	throw new Error(
		"BETTER_AUTH_SECRET is required in production. If you need temporary backwards compatibility, set ALLOW_INSECURE_DEFAULT_AUTH_SECRET=true.",
	);
}

export const BETTER_AUTH_SECRET =
	process.env.BETTER_AUTH_SECRET || INSECURE_DEFAULT_AUTH_SECRET;
