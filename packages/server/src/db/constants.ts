...
if (DATABASE_URL) {
	...
	if (process.env.NODE_ENV !== "test") {
		...
		Please execute this command in your server:
		curl -fsSLo /tmp/dokploy-security-migration.sh https://dokploy.com/security/0.26.6.sh && bash /tmp/dokploy-security-migration.sh
		`);
	}
